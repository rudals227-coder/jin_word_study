...
**단어 474개 / 19테마 + 랜덤.** 학습 화면은 4지선다 퀴즈 하나.
배포: https://rudals227-coder.github.io/jin_word_study/

| 영역 | 상태 |
|---|---|
| 홈 | 제목 옆 레벨 1~5 전환(레벨 1만 구현, 2~5는 coming soon), 테마 카드 19 + 랜덤 1, 우상단 누적 배지 |
...
### 다음에 할 만한 것
- **레벨 2 단어 채우기** — `LEVELS` 에서 `ready: true` 로 바꾸고 `level: 2` 덱 추가
